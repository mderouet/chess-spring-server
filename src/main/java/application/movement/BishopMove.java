...
public interface BishopMove {
    default boolean diagonalMove(Map<String, Piece> board, String squareCoordDeparture,
                                 String squareCoordArrival) {
        Color opponentColor = board.get(squareCoordDeparture).opponentColor();

        List<Integer> yArray = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8));

        List<String> xArray = new ArrayList<>(Arrays.asList("A", "B", "C", "D", "E", "F", "G", "H"));
